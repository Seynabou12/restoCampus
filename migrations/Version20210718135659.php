 ...
 */
final class Version20210718135659 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, plats_id INT DEFAULT NULL, détails_menu VARCHAR(255) NOT NULL, nom_menu VARCHAR(255) NOT NULL, INDEX IDX_7D053A93AA14E1C8 (plats_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
